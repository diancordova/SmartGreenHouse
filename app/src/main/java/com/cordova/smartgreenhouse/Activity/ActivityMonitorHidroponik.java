...
public class ActivityMonitorHidroponik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_hidroponik);
        ...
        refWaterLevel = refHome.child("waterLevel");
        ...
        refSuhuAir = refHome.child("suhu");
        refNilaiSuhuAir = refSuhuAir.child("value");
