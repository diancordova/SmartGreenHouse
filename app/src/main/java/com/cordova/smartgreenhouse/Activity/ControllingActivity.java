...
public class ControllingActivity extends AppCompatActivity {
    ...
    DatabaseReference refDHT, refTemp, refHmd,refPhotoDioda,refTumbuhan,
            refUrl,refStatusLampuUV,refStatusPhotoDioda,refLampuUV,refSpringkle,refStatusSprinkle,refManual,refStatusManual,refIsLoading,refIsLoading1;
...
//        controlSprinkle(refStatusSprinkle);
            monitorTumbuhan(refUrl);
        notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);

    }
    private void monitorTumbuhan( DatabaseReference refUrl) {
        showDialog();
                    ...
                    FirebaseMessaging.getInstance().subscribeToTopic("weather")
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Log.d("ini:", msg);
                                    Toast.makeText(ControllingActivity.this, msg, Toast.LENGTH_SHORT).show();
                                }
                            });
