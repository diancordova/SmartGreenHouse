...
public class ActivityMonitorGreenHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_green_house);
                    ...
                    FirebaseMessaging.getInstance().subscribeToTopic("weather")
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Log.d("ini:", msg);
                                    Toast.makeText(ActivityMonitorGreenHouse.this, msg, Toast.LENGTH_SHORT).show();
                                }
                            });
